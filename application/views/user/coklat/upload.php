...
<div class="panel panel-default">
  ...
  <div class="panel-body">
     <form action="<?php echo base_url('index.php/coklat/insert_rasa');?>" method="post" enctype="multipart/form-data">
       <table class="table table-striped">
        
          <tr>
          <td style="width:15%;">id tempat</td>
          <td>
            <div class="col-sm-10">
                 <input type="text" name="id_bakpia" class="form-control">
            </div>
            </td>
         </tr>
         <tr>
          <td style="width:15%;">rasa</td>
          <td>
            <div class="col-sm-10">
