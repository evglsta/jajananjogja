        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
            	...
            	<div class="card" style="width: 30%; float: left" align="center">
  					<img class="card-img-top" src="<?php echo base_url('assets/images/coklat/'.$row->gambar);?>">
  					<div class="card-body">
  ...
  <a type="button" href="<?php echo base_url('index.php/coklat/add');?>" style="color: white">TAMBAH</a>