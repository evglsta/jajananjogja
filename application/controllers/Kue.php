...
class Kue extends CI_Controller
{
	...
	{       
        $data['query'] = $this->m_kue->get_allimage();
        $this->load->view('components/header');
        $this->load->view('user/kue/index',$data);
        $this->load->view('components/footer');
    }

    function add()
    {
	    $this->load->view('user/kue/fupload');   
    }
    ...
    function insert(){
        ...
        $config['upload_path'] = './assets/images/kue/'; //path folder
     ...
     public function insert_rasa(){
        ...
        if($_FILES['gambar']['name'])
        {
            if ($this->upload->do_upload('gambar'))
            {
                ...
                $this->m_kue->get_insertrasa($data);
